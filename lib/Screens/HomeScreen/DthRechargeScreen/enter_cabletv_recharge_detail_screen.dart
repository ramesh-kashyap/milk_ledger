...
class EnterCableTvRechargeDetailScreen extends StatelessWidget {
  EnterCableTvRechargeDetailScreen({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                ...
                prefixIcon: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.asset(Images.act, height: 25, width: 25),
                    ),
                    SizedBox(width: 10),
                    Container(
                      height: 40,
            ...
            SizedBox(height: 20),
            CommonTextWidget.InterMedium(
              text: "Mobile Number/Account Number/MAC ID",
              fontSize: 14,
              color: black171,
            ),
            SizedBox(height: 10),
