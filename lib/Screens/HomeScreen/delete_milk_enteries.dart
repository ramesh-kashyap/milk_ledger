...
class DeleteMilkEntriesScreen extends StatefulWidget {
  ...
  @override
  State<DeleteMilkEntriesScreen> createState() =>
      _DeleteMilkEntriesScreenState();
}

class _DeleteMilkEntriesScreenState
    extends State<DeleteMilkEntriesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("delete_milk_enteries".tr,
